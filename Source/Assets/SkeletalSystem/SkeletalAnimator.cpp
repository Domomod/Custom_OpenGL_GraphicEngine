...
{
    currentTime = fmod(glfwGetTime() - startingTime,
                       currentAnimation->getDurationInTicks() / currentAnimation->getTicksPerSecond());
...
void
SkeletalSystem::SkeletalAnimator::calculateHierarchyTransforms(const std::shared_ptr<SkeletalSystem::Bone> &bone,
