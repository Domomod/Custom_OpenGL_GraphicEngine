...
static inline glm::vec4 glmCast(const aiVector3D &v, float fourthValue)
{
    return glm::vec4(v.x, v.y, v.z, fourthValue);
}

static inline glm::vec4 glmCast(const aiColor4D &v)
{
    return glm::vec4(v.r, v.g, v.b, v.a);
}

static inline glm::vec3 glmCast(const aiVector3D &v)
{
...
static inline glm::mat4 glmCast(const aiMatrix4x4 &m)
{
