...
{
public:
    ShaderCompilationFailedException(const std::string &msg = "No message was set") : MyException(
            "ShaderCompilationFailedException", msg)
    {
    }
};
...
{
public:
    GluintIdAlreadySetException(const std::string &msg = "No message was set") : MyException(
            "GluintIdAlreadySetException", msg)
    {
    }
};
...
{
public:
    ShadersNotCreatedException(const std::string &msg = "No message was set") : MyException(
            "ShadersNotCreatedException", msg)
    {
    }
};
...
{
public:
    IncorrectShaderTypeException(const std::string &msg = "No message was set") : MyException(
            "IncorrectShaderTypeException", msg)
    {
    }
};
...
{
public:
    ProgramConsolidationFailedException(const std::string &msg = "No message was set") : MyException(
            "ProgramConsolidationFailedException", msg)
    {
    }
};
...
{
public:
    NoSuchGlslElementException(const std::string &msg = "No message was set\nTip: check for misspelling errors.")
            : MyException("NoSuchUniformException", msg)
    {
    }
};
...
public:
    GlfwInitalisationFailedException(const std::string &msg = "No message was set\n") : MyException(
            "GlfwInitalisationFailedException", msg)
    {
    }
...
{
public:
    ModelLoadingException(const std::string &msg = "No message was set\n", const std::string &name = "") : MyException(
            "ModelLoadingException:\t" + name, msg)
    {
    }
};
...
public:
    AnimationInterpolationError(const std::string &msg = "No message was set\n") : MyException(
            "AnimationInterpolationError", msg)
    {
    }
};
...
public:
    TextureConverterShaderNotSet(const std::string &msg = "No message was set\n") : MyException(
            "TextureConverterShaderNotSet", msg)
    {
    }
};
...
public:
    InvalidOpenGLTypeException(const std::string &msg = "No message was set\n") : MyException(
            "InvalidOpenGLTypeException", msg)
    {
    }
};
